...
#define AUTOCONNECT_MENULABEL_CONFIGNEW   "Connect to WiFi"
//#define AUTOCONNECT_MENULABEL_CONFIGNEW   "Establish a new connection"
...
//#define AUTOCONNECT_MENULABEL_HOME        "Smart Power Solutions - EM03"
