...
#elif defined(ARDUINO_ARCH_ESP32)
#define AUTOCONNECT_APID  "SPSem03"
...
#define AUTOCONNECT_AUXURI_PARAM  "sps_uri"
#endif // !AUTOCONNECT_AUXURI_PARAM

// AutoConnect menu title
#ifndef AUTOCONNECT_MENU_TITLE
#define AUTOCONNECT_MENU_TITLE  "SPS EM-03 Connection Manager"
